...
<link rel="stylesheet"
	href="${rootPath}/static/css/table.css?ver=2022-05-31-007">
<link rel="stylesheet"
	href="${rootPath}/static/css/modal.css?ver=2022-05-31-003">
<link rel="stylesheet"
	href="${rootPath}/static/css/input.css?ver=2022-05-31-003">
	<script>
		const rootPath = '${rootPath}'
	</script>
	<script src="${rootPath}/static/js/input.js?ver=2022-05-30-007">
