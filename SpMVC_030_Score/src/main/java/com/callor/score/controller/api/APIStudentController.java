 ...
 * method 에 적용을 한다.
 * 
 * @RestController 클래스는 request 에 대해서 기본 값으로 
...
@CrossOrigin(origins = {"http://localhost:3000","http://12.70.0.1:3000","http://192.168.0.*:3000"})
@RestController
...
public class APIStudentController {
	 ...
	 * 
	 * Serialize 된 POST body 에 담긴 데이터를  Controller 에서 VO 로 받을때는
	...
	/*
	 * http://localhost:8080/score/student/학번/delete 로 요청했을때
	...
	public int intMethod() {
		// return type 이 int 형 이므로 최소 0이라도 return 해야한다
