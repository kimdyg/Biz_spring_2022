...
<script src="${rootPath}/static/js/input.js?ver=2022-06-08-015"></script>
...
<body>
	...
	<nav>
		<ul>
			...
			<li class="log1"><a class="log1" href="${rootPath}/user/login">로그인</a></li>
			<li class="log2"><a  href="${rootPath}/user/join">회원가입</a></li>
			</c:if>
	...
	<footer class="main">
		<address> &copy; rlaeldujd@naver</address>
	</footer>
	<div class="w3-modal modal-result">
		<div class="w3-modal-content w3-card-4">
			<header class="w3-container w3-teal">
				<span class="w3-button w3-display-topright modal-close"></span>
				<h2>도서 검색 정보</h2>
			</header>
