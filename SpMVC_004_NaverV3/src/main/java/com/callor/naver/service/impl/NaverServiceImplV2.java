...
public class NaverServiceImplV2 extends NaverServiceImpl {
	...
	public List<Object> getNaver(String queryString) {
		...
		/*
		 * 
		 * 여기에서 VO type 타입을 BookVO 로 확정지어 쓴다
		 */
		...
		try {
			...
			log.debug(naverChannel.channel.toString());
		...
		//Naver 에서 받은 데이터는 resData 의 body에 담겨있다
		// Body 데이터를 get 하여 그 데이터중에서 items만 추출하여
		// Controller 로 return
		return null;
	}
