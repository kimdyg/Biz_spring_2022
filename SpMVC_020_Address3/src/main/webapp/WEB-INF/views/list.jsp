		...
		<tbody>
				<c:forEach items="${ADDRS}" var="ADDR">
					<tr >
						...
						<td onclick="onclickEvent(this)" data-seq="${ADDR.a_seq}">${ADDR.a_tel}</td>
						<td onclick="onclickEvent(this)" data-seq="${ADDR.a_seq}">${ADDR.a_address}</td>
					</tr>
				</c:forEach>
		</tbody>
	</table>
	<%@ include file="/WEB-INF/views/pagination.jsp" %>
	<a href="${rootPath}/insert">주소추가하기</a>
</body>
</html>